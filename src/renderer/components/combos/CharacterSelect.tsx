...
export const CharacterSelect = (props: any) => {
  ...
  const parseValue = (val: any) =>
    val === undefined || val === null || val === "" ? undefined : val.map ? val.map(optionToValue) : optionToValue(val);
  const formatValue = (val: any) =>
    val === undefined || val === null || val === "" ? undefined : val.map ? val.map(valueToOption) : valueToOption(val);
